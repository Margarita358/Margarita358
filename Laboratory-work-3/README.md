...
Рис. 8: Фрагмент екрану з рішенням завдання 2.1.1.8: Перехід на гілку «Laboratory-work-3» на GitHub та редагування README.md.## Проста обробка текстових даних засобами оболонки Unix-подібних ОС інтерпретатора команд ОС
